...
class StoreCompteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Étape 3: Mandataires
            'etape3.mandataire_1.sexe' => 'nullable|in:masculin,feminin',
            'etape3.mandataire_1.nom' => 'nullable|string|max:255',
            'etape3.mandataire_1.prenom' => 'nullable|string|max:255',
            'etape3.mandataire_1.date_naissance' => 'nullable|date|before:today',
            'etape3.mandataire_1.lieu_naissance' => 'nullable|string|max:255',
            'etape3.mandataire_1.telephone' => 'nullable|string|max:20',
            'etape3.mandataire_1.adresse' => 'nullable|string',
            'etape3.mandataire_1.nationalite' => 'nullable|string|max:255',
            'etape3.mandataire_1.profession' => 'nullable|string|max:255',
            'etape3.mandataire_1.nom_jeune_fille_mere' => 'nullable|string|max:255',
            'etape3.mandataire_1.numero_cni' => 'nullable|string|max:50',
            'etape3.mandataire_1.situation_familiale' => 'nullable|in:marie,celibataire,autres',
