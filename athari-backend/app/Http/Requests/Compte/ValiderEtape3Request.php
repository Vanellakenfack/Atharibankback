...
class ValiderEtape3Request extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mandataire_2.sexe' => 'required_with:mandataire_2|in:masculin,feminin',
            'mandataire_2.nom' => 'required_with:mandataire_2|string|max:255',
            'mandataire_2.prenom' => 'required_with:mandataire_2|string|max:255',
            'mandataire_2.date_naissance' => 'required_with:mandataire_2|date|before:today',
            'mandataire_2.lieu_naissance' => 'required_with:mandataire_2|string|max:255',
            'mandataire_2.telephone' => 'required_with:mandataire_2|string|max:20',
            'mandataire_2.adresse' => 'required_with:mandataire_2|string',
            'mandataire_2.nationalite' => 'required_with:mandataire_2|string|max:255',
            'mandataire_2.profession' => 'required_with:mandataire_2|string|max:255',
            'mandataire_2.nom_jeune_fille_mere' => 'nullable|string|max:255',
            'mandataire_2.numero_cni' => 'required_with:mandataire_2|string|max:50',
            'mandataire_2.situation_familiale' => 'required_with:mandataire_2|in:marie,celibataire,autres',
